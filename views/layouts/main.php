                    ...
                    'items' => [
                        ...
                        [
                            ...
                            'items' => [
                                ...
                                '<div class="dropdown-divider"></div>',
                                ['label' => '<i class="fas fa-archive me-2"></i> Zarządzanie archiwami', 'url' => ['/archive/index'], 'encode' => false],
                                ['label' => '<i class="fab fa-aws me-2"></i> Konfiguracja S3', 'url' => ['/s3-config/index'], 'encode' => false],
                                ['label' => '<i class="fas fa-cloud-upload-alt me-2"></i> Transfery S3', 'url' => ['/s3-transfer/index'], 'encode' => false],
                                ['label' => '<i class="fas fa-chart-line me-2"></i> Konfiguracja monitoringu',
